package com.example.campusmanagementsystemcmsfinal.StudentPortal;
...
import com.example.campusmanagementsystemcmsfinal.StudentPortal.ui.gallery.Attendance;
import com.example.campusmanagementsystemcmsfinal.StudentPortal.ui.slideshow.Result;
...
import com.example.campusmanagementsystemcmsfinal.databinding.ActivityStudentBinding;
...
public class Student extends AppCompatActivity {
    ...
    public void navigateToAttendanceFragment(String name) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_student);
        navController.navigate(R.id.action_nav_gallery_to_nav_attendance2, bundle);
    ...
    public void navigateToResultFragment(String name) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_student);
        navController.navigate(R.id.action_nav_slideshow_to_nav_sattendance, bundle);
